...
public class Computer {
    public static void main(String[] args) {
        ...
        int discount,quantity = 0;
        double price,producttotal,servicestotal,total = 0,totalprice = 0,grandtotal = 0;
        boolean y = true;
        ...
        while(input.equalsIgnoreCase("y")!=y && input.equalsIgnoreCase("n")!=y){
            input = (String)JOptionPane.showInputDialog(null,"You are required to follow the instruction in assuring the system to work properly.\n\nEnter membership [Y] for Yes @ [N] for No:","Ecgmr",JOptionPane.ERROR_MESSAGE);
        }
        ...
        do{
            ...
            if(st.equals(selectType[0])){
                do{
                    ...
                    grandtotal = (grandtotal + producttotal) - (producttotal * discount/100);
                    productchosen = productchosen+"          - "+category+"          RM "+x.format(price)+" x "+quantity+" = RM "+x.format(producttotal)+"\n";
                ...
                do{
                    ...
                    totalprice = totalprice + servicestotal;
                    grandtotal = (grandtotal + servicestotal) - (servicestotal * discount/100);
                    serviceschosen = serviceschosen + "          - "+category+"          RM "+x.format(price)+" x "+quantity+" = RM "+x.format(servicestotal)+"\n";
